...
$(document).ready(function() {
	...
	chatSocket.onmessage = function(e) {
		...
		if(data_about=='chat'){
			if(sender_id == current_user_id){
				...
				add_msg_received(msg);
			}
			
		}
		else if(data_about=='public_key'){
			$('#chat_section').append("<input type='hidden' value='"+msg+"' id='public_key'/>");
    ...
    // The add  msg sent html jquery
    function add_msg_sent(msg) {
    	var html = `
			<div class="d-flex justify-content-end mb-4" >
				<div class="msg_cotainer_send" title= "Today 9:10 AM">
					<span  >${msg}</span>
				</div>
				<div class="img_cont_msg" title= "Username">
		...
		`;
    	$('#current_chat_room').append(html);
    }
    // The msg received html jquery
    function add_msg_received(msg) {
    	var html = `
			...
			<div class="msg_cotainer" title= "Today 9:10 AM">
				<span>${msg}</span>
			</div>
		</div>
		`;
